...
function row(msgStatus, msgSubStatus, transactionStatus, transactionStatusReason, reasonDescription, overrides = {
        ...
        subFlows: [
            {
                ...
                rows: [
                    ...
                    row('SENT_TO_CLEARING', 'POSTING_PENDING_CLEARING_INFORMED', 'PDNG', 'CLEARING_PENDING', 'Clearing informed while posting remains pending.', { cdmNotification: true }),
                    row('COMPLETE', 'POSTING_COMPLETE_CLEARING_INFORMED', 'ACCC', 'COMPLETED', 'Payment completed and clearing was informed.', { channelPushNotification: true, cdmNotification: true })
                ]
            },
            {
                ...
                rows: [
                    ...
                    row('PENDING', 'RECEIVED_FOR_PROCESSING', 'PDNG', 'PROCESSING', 'Future-dated payment queued for orchestration.'),
                    ...
                    row('SENT_TO_CLEARING', 'POSTING_PENDING_CLEARING_INFORMED', 'PDNG', 'CLEARING_PENDING', 'Clearing informed while posting remains pending after release.', { cdmNotification: true }),
                    row('SENT_TO_CLEARING', 'POSTING_COMPLETE_CLEARING_INFORMED', 'PDNG', 'CLEARING_ACKNOWLEDGED', 'Posting completed and clearing acknowledged the update.', { cdmNotification: true }),
                    row('COMPLETE', 'POSTING_COMPLETE', 'ACCC', 'COMPLETED', 'Future-dated payment completed on value date.', { channelPushNotification: true, cdmNotification: true })
                ]
            }
        ]
    },
        ...
        subFlows: [
            {
                ...
                rows: [
                    ...
                    row('COMPLETE', 'POSTING_COMPLETE', 'ACCC', 'COMPLETED', 'BOOK transfer completion confirmed.', { channelPushNotification: true, cdmNotification: true })
                ]
            },
            {
                ...
                rows: [
                    ...
                    row('PENDING', 'RECEIVED_FOR_PROCESSING', 'PDNG', 'PROCESSING', 'Future-dated BOOK transfer queued for orchestration.'),
                    ...
                    row('COMPLETE', 'POSTING_COMPLETE', 'ACCC', 'VALUE_DATED', 'Future-dated BOOK transfer completed on value date.', { cdmNotification: true }),
                    row('COMPLETE', 'POSTING_COMPLETE', 'ACCC', 'COMPLETED', 'BOOK transfer final confirmation sent.', { channelPushNotification: true, cdmNotification: true })
                ]
            }
        ]
    },
        ...
        subFlows: [
            {
                ...
                rows: [
                    ...
                    row('SENT_TO_CLEARING', 'POSTING_PENDING_CLEARING_INFORMED', 'PDNG', 'CLEARING_PENDING', 'Payment sent to clearing while posting remains pending.', { cdmNotification: true }),
                    row('REJECTED', 'CLEARING_REJECT_POSTING_PENDING', 'RJCT', 'CLEARING_REJECTED', 'Clearing rejected the payment before posting completed.', { cdmNotification: true }),
                    row('REJECTED', 'CLEARING_REJECT_POSTING_COMPLETE', 'RJCT', 'FINAL_REJECTED', 'Clearing rejection persisted after posting reconciliation.', { channelPushNotification: true, cdmNotification: true })
                ]
            },
            {
                ...
                rows: [
                    ...
                    row('PENDING', 'SANCTIONS_SENT', 'PDNG', 'SANCTIONS_REQUESTED', 'Sanctions screening requested after release.'),
                    row('PENDING', 'BALANCE_CHECK_PENDING', 'PDNG', 'LIQUIDITY_CHECK', 'Balance validation pending before clearing.'),
                    row('SENT_TO_CLEARING', 'POSTING_PENDING_CLEARING_INFORMED', 'PDNG', 'CLEARING_PENDING', 'Payment sent to clearing after future-date release.', { cdmNotification: true }),
                    row('REJECTED', 'CLEARING_REJECT_POSTING_PENDING', 'RJCT', 'CLEARING_REJECTED', 'Clearing rejected the future-dated payment before posting completed.', { cdmNotification: true }),
                    row('REJECTED', 'CLEARING_REJECT_POSTING_COMPLETE', 'RJCT', 'RECONCILED_REJECTED', 'Clearing rejection reconciled after posting updates.', { cdmNotification: true }),
                    row('REJECTED', 'CLEARING_REJECT_POSTING_COMPLETE', 'RJCT', 'FINAL_REJECTED', 'Future-dated clearing rejection confirmation sent.', { channelPushNotification: true, cdmNotification: true })
                ]
            }
        ]
    },
        ...
        subFlows: [
            {
                ...
                rows: [
                    ...
                    row('PENDING', 'RECEIVED_FOR_PROCESSING', 'PDNG', 'BUSINESS_VALIDATION_STARTED', 'Business validation started for the payment.'),
                    row('REJECTED', 'ACCOUNT_INVALID', 'RJCT', 'ACCOUNT_INVALID', 'Rejected because the debtor or creditor account is invalid.', {
                        scenario: 'Account invalid',
                        responsibleComponent: 'Business Validation Service',
                        channelPushNotification: true,
                        cdmNotification: true
                    }),
                    row('REJECTED', 'ACCOUNT_CLOSED', 'RJCT', 'ACCOUNT_CLOSED', 'Rejected because the account is closed.', {
                        scenario: 'Account closed',
                        responsibleComponent: 'Business Validation Service',
                        channelPushNotification: true,
                        cdmNotification: true
                    }),
                    row('REJECTED', 'INVALID_ACCOUNT_CLASS', 'RJCT', 'INVALID_ACCOUNT_CLASS', 'Rejected because the account class is not eligible.', {
                        scenario: 'Invalid account class',
                        responsibleComponent: 'Business Validation Service',
                        channelPushNotification: true,
                        cdmNotification: true
                    }),
                    row('REJECTED', 'TAX_INFO_MISSING', 'RJCT', 'TAX_INFO_MISSING', 'Rejected because tax information is missing.', {
                        scenario: 'Tax information missing',
                        responsibleComponent: 'Business Validation Service',
                        channelPushNotification: true,
                        cdmNotification: true
                    }),
                    row('REJECTED', 'INVALID_TAX_ID', 'RJCT', 'INVALID_TAX_ID', 'Rejected because the tax identifier is invalid.', {
                        scenario: 'Invalid tax ID',
                        responsibleComponent: 'Business Validation Service',
                        channelPushNotification: true,
                        cdmNotification: true
                    }),
                    row('REJECTED', 'ALIAS_NOT_RESOLVED', 'RJCT', 'ALIAS_NOT_RESOLVED', 'Rejected because the alias could not be resolved.', {
                        scenario: 'Alias not resolved',
                        responsibleComponent: 'Business Validation Service',
                        channelPushNotification: true,
                        cdmNotification: true
                    }),
                    row('REJECTED', 'CREDITOR_MEMBERSHIP_INVALID', 'RJCT', 'CREDITOR_MEMBERSHIP_INVALID', 'Rejected because creditor membership is invalid.', {
                        scenario: 'Creditor membership invalid',
                        responsibleComponent: 'Business Validation Service',
                        channelPushNotification: true,
                        cdmNotification: true
                    }),
                    row('REJECTED', 'DUPLICATE', 'RJCT', 'DUPLICATE', 'Rejected because a duplicate payment was detected.', {
        ...
        subFlows: [
            {
                ...
                rows: [
                    ...
                    row('CANCELLED', 'STOP_RECALL_REQUEST', 'RJCT', 'STOP_ACCEPTED', 'Stop payment approved before sanctions hold.'),
                    row('CANCELLED', 'STOP_RECALL_REQUEST', 'RJCT', 'FINAL_CANCELLED', 'Cancellation confirmed to downstream systems.', { channelPushNotification: true, cdmNotification: true })
                ]
            },
            {
                ...
                rows: [
                    ...
                    row('CANCELLED', 'STOP_RECALL_REQUEST', 'RJCT', 'FINAL_CANCELLED', 'Cancellation confirmation sent to downstream systems.', { channelPushNotification: true, cdmNotification: true })
                ]
            },
            {
                ...
                rows: [
                    ...
                    row('CANCELLED', 'STOP_RECALL_REQUEST', 'RJCT', 'FINAL_CANCELLED', 'Cancellation propagated to all systems.', { channelPushNotification: true, cdmNotification: true })
                ]
            },
            {
                ...
                rows: [
                    ...
                    row('CANCELLED', 'STOP_RECALL_REQUEST', 'RJCT', 'FINAL_CANCELLED', 'Stop payment completion recorded.', { channelPushNotification: true, cdmNotification: true })
                ]
            },
            {
                title: 'STOP Payment Flow - NON PAY statuses',
                rows: [
                    row('NON_PAY_COMPLETE', 'NON_PAY_RECEIVED_FOR_PROCESSING', 'PDNG', 'NON_PAY_ACTIVE', 'Non-pay item received for processing.'),
                    row('NON_PAY_COMPLETE', 'STOP_RECALL_REQUEST', 'PDNG', 'NON_PAY_STOP_REQUESTED', 'Stop request received for non-pay item.'),
                    row('NON_PAY_REJECTED', 'STOP_RECALL_REQUEST', 'RJCT', 'NON_PAY_CANCELLED', 'Non-pay item rejected after stop request.'),
                    row('NON_PAY_REJECTED', 'STOP_RECALL_REQUEST', 'RJCT', 'FINAL_REJECTED', 'Non-pay rejection confirmation sent.', { channelPushNotification: true, cdmNotification: true })
                ]
            }
        ]
    },
        ...
        subFlows: [
            {
                ...
                rows: [
                    row('COMPLETE', 'POSTING_COMPLETE', 'ACCC', 'CATEGORY_A', 'Posting completed successfully for Category A response.', { scenario: 'Category A response', channelPushNotification: true, cdmNotification: true }),
                    row('PENDING', 'POSTING_PENDING_CLEARING_INFORMED', 'PDNG', 'CATEGORY_B', 'Posting remains pending while clearing has been informed for Category B response.', { scenario: 'Category B response', cdmNotification: true }),
                    row('REJECTED', 'CLEARING_REJECT_POSTING_PENDING', 'RJCT', 'CATEGORY_C', 'Posting response requires payment rejection for Category C response.', { scenario: 'Category C response', channelPushNotification: true, cdmNotification: true })
                ]
            }
        ]
    },
        ...
        subFlows: [
            {
                title: 'SPM Scenarios',
                rows: [
                    row('PENDING', 'SPM_SENT', 'PDNG', 'SPM_REQUESTED', 'SPM request submitted to the screening engine.', { scenario: 'SPM request submitted', responsibleComponent: 'SPM Service' }),
                    row('REJECTED', 'SPM_FAILED', 'RJCT', 'SPM_FAILED', 'SPM returned a business failure.', {
                        scenario: 'SPM failed response',
                        responsibleComponent: 'SPM Service',
                        channelPushNotification: true,
                        cdmNotification: true
                    }),
                    row('REJECTED', 'SPM_ERROR', 'RJCT', 'SPM_ERROR', 'SPM returned a technical error.', {
        ...
        subFlows: [
            {
                ...
                rows: [
                    row('PENDING', 'SANCTIONS_SENT', 'PDNG', 'SANCTIONS_REQUESTED', 'Sanctions request submitted.', { scenario: 'Sanctions request submitted' }),
                    row('PENDING', 'OFAC_POSSIBLE_HIT', 'PDNG', 'OFAC_REVIEW', 'Possible OFAC hit identified for manual review.', { scenario: 'Possible OFAC hit' }),
                    row('REJECTED', 'SANCTION_REJECTED', 'RJCT', 'SANCTIONS_REJECTED', 'Payment rejected because sanctions screening failed.', { scenario: 'Sanctions rejected payment', channelPushNotification: true, cdmNotification: true }),
                    row('CANCELLED', 'SANCTION_CANCELLED', 'RJCT', 'SANCTIONS_CANCELLED', 'Payment cancelled after sanctions workflow closed.', { scenario: 'Sanctions cancelled payment', channelPushNotification: true, cdmNotification: true }),
                    row('SEIZED', 'SANCTIONS_SEIZED', 'RJCT', 'SANCTIONS_SEIZED', 'Funds seized after sanctions determination.', { scenario: 'Funds seized after sanctions review', channelPushNotification: true, cdmNotification: true })
                ]
            }
        ]
    }
];
function materializeRows(nextId, rows) {
    return rows.map((item) => ({
        id: nextId(),
        ...item
    }));
}
function materializeSubFlows(nextId, subFlows) {
...
export function createDefaultStateManagerConfig(countryCode, flowDirection) {
    return {
        countryCode,
        flowDirection,
