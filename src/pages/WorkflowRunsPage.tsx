...
export function WorkflowRunsPage() {
  ...
  return (
    <SectionCard
      title="Workflow Runs"
      subtitle="Inspect execution status and failure points across onboarding pipelines."
      actions={
    ...
    >
      {filteredRuns.length ? (
        ...
        <Stack sx={{ py: 5 }} spacing={1} alignItems="center" textAlign="center">
          <Typography variant="h6">No runs for selected filter</Typography>
          <Typography variant="body2" color="text.secondary">
            Choose another status filter or refresh the data.
          </Typography>
        </Stack>
      )}
    </SectionCard>
